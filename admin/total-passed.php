...
$result = $conn->query("select distinct(examinee.id), examinee.first_name, examinee.email from results inner join examinee on examinee.id = results.examinee_id where results.passed = 1") or die($conn->error);
